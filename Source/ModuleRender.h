...
public:
	...
	bool DrawTexture(SDL_Texture* texture, int x, int y, SDL_Rect* section = nullptr, bool flip = false, float speed = 1.0f);
...
/// <returns></returns>
	bool DrawTexture(SDL_Texture* texture, iPoint pos, SDL_Rect* section = nullptr, bool flip = false, float speed = 1.0f);
